...
public interface GroupContract {
    ...
    interface SingleEventBusGroupContract extends EventBusContract {
        ...
        default void groupDeliveryShouldNotExceedRate() {
            ...
            waitCondition(getSpeedProfile()).atMost(org.awaitility.Duration.TEN_MINUTES).untilAsserted(() -> assertThat(finishedExecutions.get()).isEqualTo(eventCount));
        ...
        default void groupNotificationShouldDeliverASingleEventToAllListenersAtTheSameTime() {
            ...
            try {
                ...
                waitCondition(getSpeedProfile()).atMost(org.awaitility.Duration.TEN_SECONDS)
