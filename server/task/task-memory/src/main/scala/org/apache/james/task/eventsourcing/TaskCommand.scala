...
object TaskCommand {
  ...
  case class Fail(id: TaskId, taskType: TaskType, additionalInformation: Option[AdditionalInformation]) extends TaskCommand

  case class Cancel(id: TaskId, taskType: TaskType, additionalInformation: Option[AdditionalInformation]) extends TaskCommand
