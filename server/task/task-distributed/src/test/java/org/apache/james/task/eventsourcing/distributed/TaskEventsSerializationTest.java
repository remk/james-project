...
class TaskEventsSerializationTest {
    ...
    private static Stream<Arguments> validTasks() throws Exception {
        return Stream.of(
            ...
            Arguments.of(new Completed(AGGREGATE_ID, EVENT_ID, Task.Result.COMPLETED, CompletedTask.TYPE, Option.empty()), "{\"result\":\"COMPLETED\",\"aggregate\":\"2c7f4081-aa30-11e9-bf6c-2d3b9e84aafd\",\"event\":42,\"type\":\"task-manager-completed\",\"taskType\":\"completed\"}"),
            Arguments.of(new Completed(AGGREGATE_ID, EVENT_ID, Task.Result.PARTIAL, CompletedTask.TYPE, Option.empty()), "{\"result\":\"PARTIAL\",\"aggregate\":\"2c7f4081-aa30-11e9-bf6c-2d3b9e84aafd\",\"event\":42,\"type\":\"task-manager-completed\",\"taskType\":\"completed\"}"),
            Arguments.of(new Failed(AGGREGATE_ID, EVENT_ID, CompletedTask.TYPE, Option.empty()), "{\"aggregate\":\"2c7f4081-aa30-11e9-bf6c-2d3b9e84aafd\",\"event\":42,\"type\":\"task-manager-failed\",\"taskType\":\"completed\"}"),
            Arguments.of(new Cancelled(AGGREGATE_ID, EVENT_ID, CompletedTask.TYPE, Option.empty()), "{\"aggregate\":\"2c7f4081-aa30-11e9-bf6c-2d3b9e84aafd\",\"event\":42,\"type\":\"task-manager-cancelled\",\"taskType\":\"completed\"}"),
            Arguments.of(new Completed(AGGREGATE_ID, EVENT_ID, Task.Result.COMPLETED, MemoryReferenceWithCounterTask.TYPE, Option.apply(counterAdditionalInformation)), "{\"result\":\"COMPLETED\",\"aggregate\":\"2c7f4081-aa30-11e9-bf6c-2d3b9e84aafd\",\"event\":42,\"type\":\"task-manager-completed\",\"taskType\":\"memory-reference-task-with-counter\",\"additionalInformation\":\"{\\\"count\\\":3}\"}"),
            Arguments.of(new Completed(AGGREGATE_ID, EVENT_ID, Task.Result.PARTIAL, MemoryReferenceWithCounterTask.TYPE, Option.apply(counterAdditionalInformation)), "{\"result\":\"PARTIAL\",\"aggregate\":\"2c7f4081-aa30-11e9-bf6c-2d3b9e84aafd\",\"event\":42,\"type\":\"task-manager-completed\",\"taskType\":\"memory-reference-task-with-counter\",\"additionalInformation\":\"{\\\"count\\\":3}\"}"),
            Arguments.of(new Failed(AGGREGATE_ID, EVENT_ID, MemoryReferenceWithCounterTask.TYPE, Option.apply(counterAdditionalInformation)), "{\"aggregate\":\"2c7f4081-aa30-11e9-bf6c-2d3b9e84aafd\",\"event\":42,\"type\":\"task-manager-failed\",\"taskType\":\"memory-reference-task-with-counter\",\"additionalInformation\":\"{\\\"count\\\":3}\"}"),
            Arguments.of(new Cancelled(AGGREGATE_ID, EVENT_ID, MemoryReferenceWithCounterTask.TYPE, Option.apply(counterAdditionalInformation)), "{\"aggregate\":\"2c7f4081-aa30-11e9-bf6c-2d3b9e84aafd\",\"event\":42,\"type\":\"task-manager-cancelled\",\"taskType\":\"memory-reference-task-with-counter\",\"additionalInformation\":\"{\\\"count\\\":3}\"}")
        );
    }
