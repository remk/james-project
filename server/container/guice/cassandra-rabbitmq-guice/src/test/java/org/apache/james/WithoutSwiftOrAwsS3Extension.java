...
public class WithoutSwiftOrAwsS3Extension implements CassandraRabbitMQJamesServerTest, BeforeAllCallback, AfterAllCallback, BeforeEachCallback, AfterEachCallback, ParameterResolver {

    JamesServerExtension jamesServerExtension;

    WithoutSwiftOrAwsS3Extension() {
        jamesServerExtension = baseExtensionBuilder().build();
    }
