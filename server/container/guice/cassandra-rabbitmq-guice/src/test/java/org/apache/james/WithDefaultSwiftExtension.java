...
public class WithDefaultSwiftExtension implements CassandraRabbitMQJamesServerTest, BeforeAllCallback, AfterAllCallback, BeforeEachCallback, AfterEachCallback, ParameterResolver  {
