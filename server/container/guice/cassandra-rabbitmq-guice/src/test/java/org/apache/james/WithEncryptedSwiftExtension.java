...
public class WithEncryptedSwiftExtension implements CassandraRabbitMQJamesServerTest, BeforeAllCallback, AfterAllCallback, BeforeEachCallback, AfterEachCallback, ParameterResolver {
